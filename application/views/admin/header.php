                    ...
                    <div class="left-custom-menu-adp-wrap comment-scrollbar">
                        ...
                        <nav class="sidebar-nav left-sidebar-menu-pro" style=" margin-top: 30px">
                            ...
                            <ul class="metismenu text-dark" id="menu1" style="background-color: #F5F5F5;">
                                ...
                                <li style="transition: background-color 0.3s;">
                                    <a href="<?php echo base_url('admin/kode_qr'); ?>" aria-expanded="false" style="display: block; padding: 10px; text-decoration: none; color: inherit;" onmouseover="this.style.backgroundColor='#e0e0e0'" onmouseout="this.style.backgroundColor='transparent'">
                                        <i class="bi bi-qr-code"></i> Data Kode QR</span>
                                    </a>
                                </li>
